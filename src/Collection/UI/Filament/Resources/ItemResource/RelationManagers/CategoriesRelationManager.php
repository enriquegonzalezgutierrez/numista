...
class CategoriesRelationManager extends RelationManager
{
    ...
    {
        return $table
            // The attribute to use for the record title, used in notifications, etc.
            ...
            ->headerActions([
                AttachAction::make()
                    ...
                    ->modalHeading(__('panel.modal_attach_title'))
            ...
            ->bulkActions([
                BulkActionGroup::make([
                    // This action detaches all selected categories at once.
